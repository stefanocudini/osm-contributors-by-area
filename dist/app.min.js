...
$(function(){var a=15,b=new L.Map("map",{attribution:'<a href="http://leafletjs.com/">Leaflet</a> &bull; <a href="http://osm.org/" target="_blank">OpenStreetMap contributors</a>',layers:L.tileLayer("http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"),minZoom:a}),c="http://overpass-api.de/api/interpreter?";b.setView(L.latLng(42.4461,12.4937),a),L.layerJSON({url:c+"node({lat1},{lon1},{lat2},{lon2});out meta;;",propertyItems:"elements",propertyTitle:"tags.name",propertyLoc:["lat","lon"]}).on("dataloading",function(a){console.log("dataloading",a)}).on("dataloaded",function(a){console.log("dataloaded",a)}).addTo(b)});